...
class TestConfig(unittest.TestCase):
    ...
    def setUp(self):
        ...
        try:
            self.config = init_config_loader("config/config.yaml")
    ...
    def test_config_loader_initialization(self, mock_open, mock_safe_load):
        ...
        mock_safe_load.return_value = {
            ...
            'data_storage': {
                'stock_data_path': '/test/stock/data'
            }
        }
        ...
        self.assertEqual(config_loader.get_data_storage_stock_data_path(), '/test/stock/data')
    ...
    def test_get_data_storage_stock_data_path(self, mock_open, mock_safe_load):
        ...
        mock_safe_load.return_value = {
            'data_storage': {
                'stock_data_path': '/custom/stock/data/path'
            }
        }
