...
- [ ] TXXX [P] Additional unit tests (if requested) in test/unit/
...
Task: "Contract test for [endpoint] in test/contract/test_[name].py"
Task: "Integration test for [user journey] in test/integration/test_[name].py"
